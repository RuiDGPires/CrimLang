...
namespace crl {
	class Token {
		...
		//Others
		INT, DEC, TIMES, PLUS, MINUS, INC, DECR, SLASH, CHAR, STRING, DOT, AND, OR, LPAREN, RPAREN, LBRACK, RBRACK, DOLLAR, CLN, SEMICLN, COMMA, BECOMES, PLEQ, MIEQ, TIEQ, SLEQ, EQL, GEQ, LEQ, GTR, LSS, NEQ, LOR, LAND, 
