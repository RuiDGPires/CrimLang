...
namespace crl{
	class Node{
		private:
		public:
			enum Type{NONE, PROGRAM, VAR_DECLARATION, FUNC_DECLARATION, INIT, BLOCK, ASSIGN, IF, THEN, ELSE, FOR, WHILE, CALL, EXPRESSION, TERM, FACTOR, LEAF, CAS, ARG, INC, DEC, CAST, RETURN, BREAK, COMPARISON};
